...
from app.grouping import group_by_thread, group_by_similarity, get_embedding
...
def handle_message(message, client, logger):
    ...
    try:
        ...
        try:
            ...
            # Generate embedding for the message (for similarity grouping)
        ...
        print(f"\n💥 CRITICAL ERROR in message handler: {e}")
